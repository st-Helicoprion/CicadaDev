...
public class SonarBehavior : MonoBehaviour
{
    ...
    void Start()
    {
        SonarSkill = GameObject.Find("Manager/Player").GetComponent<SonarSkill>();
    ...
    void Update()
    {
        SonarScale.localScale = Vector3.Lerp(SonarScale.localScale, new Vector3(10, 10, 10), 0.3f * Time.deltaTime);
